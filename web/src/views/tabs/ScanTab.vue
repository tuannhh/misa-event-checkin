...
import { api, auth, badgeLayout } from '../../api';
  ...
  <div class="scan-layout">
    ...
    <div class="card result" :class="ui ? ui.cls : 'idle'">
      <template v-if="ui">
        ...
        <MButton v-if="att && !atBooth" variant="secondary" style="margin-top:10px;width:100%" @click="printQr(att, props.ev.id, badgeLayout(props.ev))"><MIcon name="printer" /> In thẻ QR cho khách</MButton>
      </template>
