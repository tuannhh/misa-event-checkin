// Bảng icon dùng chung MDS (Tabler Icons, stroke 1.5) — path copy nguyên văn từ bộ icon
// chính thức. Dùng chung cho MSidebar và mọi nơi cần icon+label (vd tab dọc trong trang chi
// tiết) để tránh khai báo trùng và đảm bảo icon đồng nhất trên toàn ứng dụng.
export const ICON_PATHS = {
  'alert-circle': ['M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0', 'M12 8v4', 'M12 16h.01'],
  'align-left': ['M4 6l16 0', 'M4 12l10 0', 'M4 18l14 0'],
  'align-center': ['M4 6l16 0', 'M8 12l8 0', 'M6 18l12 0'],
  'align-right': ['M4 6l16 0', 'M10 12l10 0', 'M6 18l14 0'],
  'align-justify': ['M4 6l16 0', 'M4 12l16 0', 'M4 18l16 0'],
  ...
  'door-exit': ['M13 12v.01', 'M3 21h18', 'M5 21v-16a2 2 0 0 1 2 -2h6a2 2 0 0 1 2 2v16', 'M13 5.5v13l6 2.5v-16z'],
  gift: ['M3 8m0 1a1 1 0 0 1 1 -1h16a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-16a1 1 0 0 1 -1 -1z', 'M12 8l0 13', 'M19 12v7a1 1 0 0 1 -1 1h-12a1 1 0 0 1 -1 -1v-7', 'M7.5 8a2.5 2.5 0 0 1 0 -5c1.5 0 2.5 1.5 4.5 5c2 -3.5 3 -5 4.5 -5a2.5 2.5 0 0 1 0 5'],
  puzzle: ['M4 7h2.153a1 1 0 0 0 .831 -1.545a1.848 1.848 0 0 1 -.318 -1.398c.192 -.959 1.014 -1.71 1.987 -1.755a2.021 2.021 0 0 1 2.147 2.019c0 .4 -.122 .77 -.331 1.083a1.05 1.05 0 0 0 .89 1.596h2.641c.55 0 1 .45 1 1v2.153a1 1 0 0 0 1.545 .831c.313 -.209 .683 -.331 1.083 -.331a2.021 2.021 0 0 1 2.019 2.147c-.045 .973 -.796 1.795 -1.755 1.987a1.848 1.848 0 0 1 -1.398 -.318a1 1 0 0 0 -1.545 .83v2.154a1 1 0 0 1 -1 1h-2.153a1 1 0 0 1 -.831 -1.545c.209 -.313 .331 -.683 .331 -1.083a2.021 2.021 0 0 0 -2.147 -2.019c-.973 .045 -1.795 .796 -1.987 1.755a1.848 1.848 0 0 0 .318 1.398a1 1 0 0 1 -.83 1.545h-2.154a1 1 0 0 1 -1 -1v-2.153a1 1 0 0 1 1.545 -.831c.313 .209 .683 .331 1.083 .331a2.021 2.021 0 0 0 2.019 -2.147c-.045 -.973 -.796 -1.795 -1.755 -1.987a1.848 1.848 0 0 0 -1.398 .318a1 1 0 0 1 -1.545 -.83v-2.154a1 1 0 0 1 1 -1'],
  ...
  sparkles: ['M16 18a2 2 0 0 1 2 2a2 2 0 0 1 2 -2a2 2 0 0 1 -2 -2a2 2 0 0 1 -2 2zm0 -12a2 2 0 0 1 2 2a2 2 0 0 1 2 -2a2 2 0 0 1 -2 -2a2 2 0 0 1 -2 2z', 'M3 12a5 5 0 0 1 5 5a5 5 0 0 1 5 -5a5 5 0 0 1 -5 -5a5 5 0 0 1 -5 5z'],
